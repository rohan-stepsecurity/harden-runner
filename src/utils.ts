...
export type ThirdPartyRunnerProvider = "depot" | "namespace" | "warp" | "blacksmith" | "bitrise" | "codebuild" | "fargate";
...
export function detectThirdPartyRunnerProvider(): ThirdPartyRunnerProvider | null {
  ...
  if (process.env["AWS_EXECUTION_ENV"] === "AWS_ECS_FARGATE") return "fargate";
